...
describe('Exchange', () => {
	...
	describe('Withdrawing Tokens', () => {
		...
		describe('Succes', () => {
			...
			beforeEach(async () => {
				//Depoosit tokens before withdrawing
				//Approve tokens
				transaction = await token1.connect(user1).approve(exchange.address, amount)
				result = await transaction.wait()
				//Deposit tokens
			...
			it('withdraws token deposits', async () => {
	...
	describe('Making orders', () => {
		...
		describe('Success', async () => {
			beforeEach(async () => {
				//Depoosit tokens before making order
				//Approve tokens
				transaction = await token1.connect(user1).approve(exchange.address, amount)
				result = await transaction.wait()
				//Deposit tokens
			...
			it('Emits a order event', async () => {
				const event = result.events[0] //Two events are emitted
		...
		describe('Failure', async () => {
			it('rejects accounts with no balance', async () => {
	...
	describe('Order actions', async () => {
		...
		describe('Cancelling orders', async () => {
			...
			describe('Failure', async () => {
				...
				it('rejects invallid order ids', async () => {
